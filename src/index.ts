...
import { countWords } from './job-interviews/ex1-words-counter';
import { multiplyNumbers } from './job-interviews/ex2-multiplication-table';
import { isPalindrome } from './job-interviews/ex3-palindrome';
import { countEspecificWord } from './job-interviews/ex4-word-counter';
import { reverseString } from './job-interviews/ex5-text-reverse-control-est';
import { calculatePercentage } from './job-interviews/ex6-calculate-percentage';
import { drawSquare } from './job-interviews/ex7-draw-square';
import { getOddNumbers } from './job-interviews/ex8-show-odd-numbers';
import { invertNumber } from './job-interviews/ex9-invert-number';
import { findCommonValues } from './job-interviews/ex10-array-common-values';
import { createStair } from './job-interviews/ex11-show-stair';
import { censorWord } from './job-interviews/ex12-replace-specific-word';
import { regressiveEight } from './job-interviews/ex13-regressive-eight';
import { divideArrays } from './job-interviews/ex14-divide-arrays';
import { repeatString } from './job-interviews/ex15-repeat-string';
import { findMostUsedChar } from './job-interviews/ex16-most-used-chars';
import { countVowels } from './job-interviews/ex17-count-vowels';
import { printFizzBuzz } from './job-interviews/ex18-fizz-buzz';
import { showDividers } from './job-interviews/ex19-show-dividers';
import { printFilmsByView } from './job-interviews/ex20-show-movies';
import { isAnagram } from './job-interviews/ex21-check-anagram';
import { cutText } from './job-interviews/ex22-cut-text';
import { printBiggerSmaller } from './job-interviews/ex23-bigger-number';
import { toTitleCaseRegExp } from './job-interviews/ex24-title-case';
import { isPermutation } from './job-interviews/ex25-permutation';
import { toUpperOrLowerCase, toUpperOrLowerCaseAlt } from './job-interviews/ex26-upper-lower-case';
import { fibonacci, fiboRecursive, memoizedFibo } from './job-interviews/ex27-fibonacci';
import { getYearsMonthsDays } from './job-interviews/ex28-years-months-days-by-number';
import { factorial, factorialRecursive } from './job-interviews/ex29-factorial';
import { checkCapicua } from './job-interviews/ex30-check-capicua-numbers';
import { removeDuplicatesAndStrings } from './job-interviews/ex31-no-duplicates-no-strings';
import { getAngle } from './job-interviews/ex32-geometric-angles';
import { getSquaredList } from './job-interviews/ex33-squared-numbers-array';
import { Clock } from './job-interviews/ex34-clock';
import basicMathOperations from './job-interviews/ex35-basic-math-operations';
import getFirstAndLast from './job-interviews/ex36-first-last';
import getVocalsAndConsonants from './job-interviews/ex37-count-vocals-consonants';
import getElementWithMoreOccurrences from './job-interviews/ex38-element-appearance';
import squareNumbers from './job-interviews/ex39-square-numbers';
import checkEmail from './job-interviews/ex40-check-valid-email';
import arrayLowerHigher from './job-interviews/ex41-array-lower-higher-value';
import asterisksTriangle from './job-interviews/ex42-asterisks-triangle';
import { aleatoryNumber, aleatoryNumberFloat } from './job-interviews/ex43-aleatory-number';
import getMean from './job-interviews/ex44-numbers-mean';
import getTwoWordsValues from './job-interviews/ex45-two-words-array';
import getApprovedAndFailed from './job-interviews/ex46-approved-suspended';
import getAllSubstrings from './job-interviews/ex47-possible-substrings';
import mostCommonHobbies from './job-interviews/ex48-most-common';
import charactersAppearsOnce from './job-interviews/ex49-characters-that-appears-once';
import isPropertyInObject from './job-interviews/ex50-specific-object-property';
import loopsInside from './job-interviews/ex51-loops-inside-number';
import getEvenOdd from './job-interviews/ex52-even-odd-arrays';
