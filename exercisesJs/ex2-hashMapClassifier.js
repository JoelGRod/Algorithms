 ...
 *
 * Encima nos hemos dado cuenta que algunas palabras vienen con un _ delante de la
 * palabra, por ejemplo _playstation, que significa que está
...
export default function listGifts(letter) {
  ...
  letter
    ...
    .map((gift) => {
      gift in counter ? counter[gift]++ : (counter[gift] = 1);
    });
  return counter;
}
