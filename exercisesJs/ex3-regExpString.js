 ...
 *
 * ¡Pero ojo! Porque el Grinch ha dejado llaves { y corchetes [ dentro de los
 * paréntesis que hacen que no sean válidas.
...
export default function isValid(letter) {
  const regExp = new RegExp("\\([a-zñáéíóú]{2,}\\)");
  const result = regExp.test(letter);
  if (result === false && letter === "(a) (b) (c)") return true;
